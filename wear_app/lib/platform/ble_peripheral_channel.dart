...
class BleFrameEvent {
  ...
  BleFrameEvent.conn(this.connState)
      : type = 'conn', uuid = null, data = null, mtu = null, errorMsg = null;
  BleFrameEvent.frame(this.uuid, this.data)
      : type = 'frame', connState = null, mtu = null, errorMsg = null;
  BleFrameEvent.mtu(this.mtu)
      : type = 'mtu', connState = null, uuid = null, data = null, errorMsg = null;
  BleFrameEvent.error(this.errorMsg)
      : type = 'error', connState = null, uuid = null, data = null, mtu = null;
